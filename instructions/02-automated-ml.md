...
2. In the **Notebooks** page, under **Files**, browse to the **mslearn-dp100** folder where you cloned the notebook repository, and open the **Get AutoML Prediction** notebook.
